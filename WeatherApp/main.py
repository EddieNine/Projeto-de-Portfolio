...
class WeatherApp(QWidget):
    ...
    def initUi(self):
        ...
        self.temperature_label.setObjectName("city_label")
    ...
    def get_weather(self):
        ...
        # API
        api_key = "4f94284986f9ad05227e229821e20c03"
        ...
        try:
            ...
            match response.status_code:
                ...
                case 401:
                    self.display_error("Unauthrorized:\nInvalid API key")
                case 403:
        ...
        except requests.exceptions.RequestExcepetion as req_error:
